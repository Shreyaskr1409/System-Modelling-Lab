...
% shifting
shf = input("Enter shifting: ");

sin_wave_n = a*sin(2*pi*f*t + p_diff + shf);
cos_wave_n = a*cos(2*pi*f*t + p_diff + shf);
sqr_wave_n = a*square(2*pi*f*t + p_diff + shf);
trn_wave_n = a*sawtooth(2*pi*f*t + p_diff + shf, 1/2);
